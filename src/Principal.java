...
public class Principal {
	...
	public static void main(String[] args) {
		...
		case 2: 	
			...
			j.setId_plataforma(sc04.nextLong());
		...
		case 3:
			...
			for(Jogo user : jogoDao.getJogos()) {
				...
				System.out.println("Nome: " + user.getNome_jogo() + "| Data de lançamento: " + user.getAno_lancamento() + "| Desenvolvedor: " + user.getId_empresa() +"| Plataforma: " + user.getId_plataforma());
		...
		case 5: 	
			...
			for(Plataforma user : plataformaDAO.getPlataformas()) {
				
				System.out.println("Nome: " + user.getNome_plataforma() + " - Id: " + user.getId_plataforma());
			}
